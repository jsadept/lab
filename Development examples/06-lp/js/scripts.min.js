...
$('.photo-slider').slick({
  ...
  $('.image-popup-vertical-fit').magnificPopup({
	...
	//Animate
	$('.item > img').animated('flipInY');
	$('.diagram > div').animated('flipInY');
	$('#progress > .items > div').animated('pulse');
	$('.ban').animated('flipInY');
	$('big').animated('flipInY');
	$('.logotype').animated('flipInY');


	$( ".popup-with-form" ).click(function() {
	    var product = this.previousSibling.previousSibling.previousSibling.innerHTML;
	    console.log(product);
    	$('#mentor').attr("value", product); 
	});
});
