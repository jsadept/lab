...
$(function() {
	...
	$( ".menu-btn" ).click(function() {
		...
		$('.drop-down__mobile').on('click', function(e){
			if (e.target.classList.contains("menu__minor-list-item-text")) {
			    if (e.currentTarget.classList.contains("dropul__rotate")){
					$(e.currentTarget).toggleClass( "dropul__rotate" );
			    	$(e.currentTarget).children(".dropul__mobile").slideUp(600);
			    }
			    else{
					$(e.currentTarget).toggleClass( "dropul__rotate" );
			    	$(e.currentTarget).children(".dropul__mobile").slideDown(600);
			    }
			}
		});

		$('.drop-down__mobile_next').on('click', function(e){
				console.log(e);
			$(e.currentTarget).toggleClass( "dropul__rotate" );
		    $(e.currentTarget).children(".dropul__mobile_next").slideToggle();
		});
